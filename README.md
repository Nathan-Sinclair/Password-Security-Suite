...
## Skills Gained:
- Python Development: Built interactive CLI tools with Python 3.8, leveraging requests and pwinput.
- Cybersecurity & Cryptography: Assessed password strength, entropy, and hashes; implemented breach detection (HaveIBeenPwned).
- Password Cracking & Security Testing: Used John the Ripper for MD5, SHA, NTLM, bcrypt, scrypt, and Argon2 hashes.
- File Security & Formats: Managed password-protected ZIP, RAR, 7z, PDF, and Office files.
- Automation & Containerization: Integrated Perl scripts and optional Docker support for streamlined execution.
- Problem Solving & Security Awareness: Developed secure workflows with robust error handling and documentation.
